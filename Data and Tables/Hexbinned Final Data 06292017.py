...
with open('DatawithoutSpectra.csv', 'r') as f:
    data = list(reader(f))
...
'''
line 53 plotted solely position of stars
line 59 now groups them based on ____?
they are grouped in color
'''
#plt.hexbin(ra, dec, cmap = 'hot' , gridsize = 100, label= 'Positions of Stars')
...
'''
could have propblem with lines that set bounds
